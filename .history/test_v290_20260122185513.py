...
def test_v290():
    ...
    new_text_keys = [
        ...
        "convert_menu", "convert_processing", "convert_done",
        "watermark_usage", "watermark_set", "watermark_removed",
        "resolution_menu", "resolution_changed",
        "templates_menu", "template_applied",
        "reminder_set", "reminder_notify",
    ...
    print(f"  ✅ New texts: {len(new_text_keys)} keys checked")
