...
BOT_TOKEN = "8270727558:AAHt1m_VBB9u6iVZl777qfURuD5YO6gzDZo"  # @BotFather

# ══════════════════════════════════════════════════════════════════════════════
# FFMPEG PATH
# ══════════════════════════════════════════════════════════════════════════════

FFMPEG_PATH = r"C:\ffmpeg\ffmpeg-N-122487-g43dbc011fa-win64-gpl-shared\bin\ffmpeg.exe"
FFPROBE_PATH = r"C:\ffmpeg\ffmpeg-N-122487-g43dbc011fa-win64-gpl-shared\bin\ffprobe.exe"
...
TEXTS = {
    ...
    "how_it_works": (
        ...
        "1. Отправь видео (MP4/MOV, до 50 МБ)\n"
        "2. Нажми «Уникализировать»\n"
        "3. Получи уникальное видео\n\n"
        "Каждый рендер — уникален."
    ),
    ...
    "file_too_large": "⚠️ Видео слишком большое. Максимум — 50 МБ",
    "rate_limit": "⏱ Подожди немного. Лимит — 3 видео в час.",
