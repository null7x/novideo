...
def test_keyboards():
    ...
    # Start keyboard
    kb = get_start_keyboard(Mode.TIKTOK)
    assert kb is not None
    print("✅ get_start_keyboard (TikTok) - OK")
    
    kb = get_start_keyboard(Mode.YOUTUBE)
    assert kb is not None
    print("✅ get_start_keyboard (YouTube) - OK")
    
    # Settings keyboard
    kb = get_settings_keyboard(123456)
    assert kb is not None
    ...
    # Video keyboard
    kb = get_video_keyboard("abc123")
    assert kb is not None
    print("✅ get_video_keyboard - OK")
    
    # Result keyboard
    kb = get_result_keyboard("abc123")
    assert kb is not None
