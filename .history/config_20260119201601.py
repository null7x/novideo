...
# Удаление водяного знака (обрезка снизу и сверху в процентах)
WATERMARK_CROP_TOP = 0.02      # 2% сверху (ник автора)
WATERMARK_CROP_BOTTOM = 0.12  # 12% снизу (логотип TikTok)
