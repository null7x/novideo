...
def get_video_keyboard(file_id: str) -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text=BUTTONS["uniqualize"], callback_data=f"process:{file_id}")],
    ])

def get_result_keyboard(file_id: str) -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text=BUTTONS["again"], callback_data=f"process:{file_id}")],
